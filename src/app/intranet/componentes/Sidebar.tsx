      ...
      {/* 
            <div className="flex flex-shrink-0 bg-white h-16 justify-between left-0 top-[4rem] w-full p-3 rounded-full">
                <ul className="flex align-middle justify-center w-fit">
                    ...
                    <li className={`flex px-6 py-3 text-gray-900 rounded-2xl cursor-pointer ${expandedItem === 'nosotros' ? 'bg-[#1aabe3] text-white' : 'hover:bg-[#1aabe3] hover:text-white'}`}>
                        <Link href="/intranet/pages/us" className="flex items-center" onClick={() => setExpandedItem('nosotros')}>Nosotros</Link>
                    </li>
                    <li className="relative">
                        <div className="flex px-6 py-2 text-gray-900 hover:bg-[#1aabe3] hover:text-white rounded-2xl cursor-pointer" onClick={() => toggleItem('item3')}>Áreas</div>
                        {expandedItem === 'item3' && (
                            <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-md z-10">
                    ...
                    <li className="relative">
                        <div className="flex px-6 py-2 text-gray-700 hover:bg-[#1aabe3] hover:text-white rounded-2xl cursor-pointer" onClick={() => toggleItem('item4')}>E-learning</div>
                        {expandedItem === 'item4' && (
                            <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-md z-10">
