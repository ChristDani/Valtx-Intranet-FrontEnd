    ...
    return (
        ...
        <div className="flex items-center h-16 justify-between my-6 mr-4 text-white top-0 w-full">
            ...
            <div className="flex items-center">
                ...
                <h3 className="text-black mr-2">Hola, <br></br> <b>{localStorage.getItem("userName")} {localStorage.getItem("userFirstLastName")} {localStorage.getItem("userSecondLastName")}</b></h3> 
