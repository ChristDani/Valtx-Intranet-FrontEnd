...
const UsersPage = () => {
  ...
  const createItem = async (e: any) => {
    e.preventDefault();
    setModalState({ create: true, update: false, delete: false, resetPassword: false });
    openModal();
  };
  ...
  const editItem = (e: any, id: number) => {
    e.preventDefault();
    setModalState({ create: false, update: true, delete: false, resetPassword: false });
    openModal();
    getOneItem(id);
  };
  ...
  const deleteItem = async (e: any, id: number) => {
    e.preventDefault();
    setModalState({ create: false, update: false, delete: true, resetPassword: false });
    getOneItem(id);
    openModal();
  };
  ...
  const resetPassword = (e: any) => {
    e.preventDefault();
    setModalState({ create: false, update: false, delete: false, resetPassword: true });
  }
  ...
  const closeModal = () => {
    cleanData();
    setModalState({ create: false, update: false, delete: false, resetPassword: false });
            ...
            <div className="mt-5">
              ...
              <div className="text-end">
                ...
                <button
                  type="submit"
                  className="bg-[#0C3587] border border-[#0C3587] text-white rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 hover:text-white hover:bg-[#0e0c87]"
                  onClick={(e: any) => { resetearPassword(e, editId) }}
                >
                  Confirmar
                </button>
              </div>
