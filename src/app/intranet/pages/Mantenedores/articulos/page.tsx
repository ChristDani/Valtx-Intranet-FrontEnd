...
const ArticPage = () => {
    ...
    const confirmOp = async (e: any) => {
        ...
        if (modalState.create) {
            if (editImage != null) {
                const res = await articulosServices.create(editImage, editTitle, editDesc, editLink, editOrden, editState, editId);
                getData(currentPage, itemsPorPagina, searchTitle)
                closeModal()
            } else {
            ...
            if (editImage != null) {
                const res = await articulosServices.update(editTitle, editDesc, editLink, editOrden, editState, editId, editImage)
            } else {
