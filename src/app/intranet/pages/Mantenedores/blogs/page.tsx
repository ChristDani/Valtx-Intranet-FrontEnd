...
const BlogPage = () =>{
    ...
    const getOneItem = async (id: number) => {
        const onlyOneItem = await blogServices.getOne(id);
    ...
    const confirmOp = async (e: any) => {
        ...
        if (modalState.create) {
            if (editImage != null) {
                // const res = await blogServices.create(editImage, editTitle, editDesc, editLink, editOrden, editState, editId);
                getData(currentPage, itemsPorPagina, searchTitle)
                closeModal()
            } else {
            ...
            if (editImage != null) {
                // const res = await blogServices.update(editTitle, editDesc, editLink, editOrden, editState, editId, editImage)
            } else {
                // const res = await blogServices.update(editTitle, editDesc, editLink, editOrden, editState, editId)
            }
            getData(currentPage, itemsPorPagina, searchTitle)
            closeModal()
