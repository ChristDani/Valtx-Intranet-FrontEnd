...
const NovedadesPage = () => {
    ...
    const confirmOp = async (e: any) => {
        ...
        if (modalState.create) {
            if (editImage != null) {
                const res = await novedadesServices.create(editImage, editTitle, editDesc, editLink, editOrden, editState, editId);
                getData(currentPage, itemsPorPagina, searchTitle)
                closeModal()
            } else {
            ...
            if (editImage != null) {
                const res = await novedadesServices.update(editTitle, editDesc, editLink, editOrden, editState, editId, editImage)
            } else {
