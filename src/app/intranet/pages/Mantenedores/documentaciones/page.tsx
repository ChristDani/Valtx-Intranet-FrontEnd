...
const DocuPage = () =>{
    ...
    return (
        ...
        <div className="mt-2 pt-4 ml-8 pb-8">
            <h1 className="uppercase font-bold">Mantenedor de Documentaciones</h1>
                                ...
                                dataList.map((item: any) => (
                                    <tr className="bg-white border-b hover:bg-gray-50" key={item.iid_documentacion}>
                                        ...
                                        <td className="flex gap-3 items-center justify-center my-auto px-6 h-44">
                                            ...
                                            <Link href="" className="font-medium text-blue-600 hover:underline" onClick={(e) => deleteItem(e, item.iid_documentacion)}>
                                                <svg className="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
