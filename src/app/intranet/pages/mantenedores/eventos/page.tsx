...
const EventPage = () => {
  ...
  const getData = async (page: number, items: number, titulo: string) => {
    ...
    const itemsList: any = await eventServices.getList(
      page,
      items,
      titulo,
      -1,
  ...
  const confirmOp = async (e: any) => {
    ...
    if (modalState.create) {
      ...
      if (Image != null) {
        const res = await eventServices.update(
          editTitle,
          editDesc,
          editLink,
          editOrden,
                  ...
                  <td className="flex gap-4 items-center justify-center my-auto px-6 h-28">
                    {optionUser.visualizar && (
                      <Link
                        ...
                        onClick={(e) => itemDetails(e, item.iid_evento)}
                      >
                        <svg
                          width="20"
                          height="20"
                    ...
                    {optionUser.editar && (
                      <Link
                        href=""
                        className="font-medium text-blue-600 hover:underline"
                        onClick={(e) => editItem(e, item.iid_evento)}
                      >
                        <svg
                          width="20"
                          height="20"
                    ...
                    {optionUser.eliminar && (
                      <Link
                        href=""
                        className="font-medium text-blue-600 hover:underline"
                        onClick={(e) => deleteItem(e, item.iid_evento)}
                      >
                        <svg
                          width="20"
                          height="20"
