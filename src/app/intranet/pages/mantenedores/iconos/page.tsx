  ...
  const getOptionsUser = async (id: any, path : string) => {
    ...
    const confirmOp = async (e: any) => {
        ...
        if (modalState.create) {
            if (Image != null) {
                await iconServices.create(Image, editTitle, editDesc, editLink, editOrden, editState, editId, tipoIcono);
            ...
            const res = await iconServices.delete(editId);
        } else {
            alert('detalles')
        }
                                ...
                                dataList.map((item: any) => (
                                    <tr className="bg-white border-b hover:bg-gray-50" key={item.iid_icono}>
                                        ...
                                        <td className="px-6 py-4 text-start">
                                            {
                                                iconsList.map((icon: any) => (
                                                    <div key={icon.iid_tabla_detalle}>
                                                        {
                                        ...
                                        <td className="flex gap-4 items-center justify-center my-auto px-6 h-28">
                                            {optionUser.visualizar && <Link href="" className="font-medium text-blue-600 hover:underline" onClick={(e) => itemDetails(e, item.iid_icono)}>
                                            ...
                                            {optionUser.editar && <Link href="" className="font-medium text-blue-600 hover:underline" onClick={(e) => editItem(e, item.iid_icono)}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            {optionUser.eliminar && <Link href="" className="font-medium text-blue-600 hover:underline" onClick={(e) => deleteItem(e, item.iid_icono)}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        modalState.create || modalState.update ? (
                            ...
                            <>
                                ...
                                <div className="px-5 py-3">
                                    ...
                                    <div className="mb-1 font-normal text-gray-700">Tipo Icono: {
                                        iconsList.map((icon: any) => (
                                            <div key={icon.iid_tabla_detalle}>
                                                {
                                                    icon.iid_tabla_detalle == tipoIcono ? (
